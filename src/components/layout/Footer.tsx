          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3">
                  <a href="https://wa.me/918447750546" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#da2f1d] hover:text-white transition-colors group">
                    ...
                    <span className="text-[14px] font-medium tracking-wide">WhatsApp Us: +91 8447750546</span>
                  </a>
                </div>
              </li>
              <li className="flex flex-col gap-2">
