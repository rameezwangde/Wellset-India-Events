          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="https://www.instagram.com/wellsetindia" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#da2f1d] hover:-translate-y-1 hover:shadow-lg text-white transition-all duration-300">
                ...
                <Link href="https://youtube.com/@nukkadnatakcompany" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#da2f1d] hover:-translate-y-1 hover:shadow-lg text-white transition-all duration-300">
