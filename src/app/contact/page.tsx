...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/919310996542?text=${text}`, '_blank');
  };
                ...
                <div className="flex flex-col gap-8 relative z-10">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <a href="https://wa.me/919310996542" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-cream/80 hover:text-[#25D366] transition-colors text-[16px] mt-1 font-medium group">
